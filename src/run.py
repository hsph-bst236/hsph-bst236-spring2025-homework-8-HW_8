...
if args.function == 'pretrain':
    ...
    train_model = trainer.Trainer(model, pretrain_dataset, None, tconf)
    train_model.train()
    ...
    if args.reading_params_path is not None:
        ...
        max_epochs = 10  # Hyperparameters for finetuning WITH a pretrained model
    else:
        max_epochs = 75  # Hyperparameters for finetuning WITHOUT a pretrained model
    ...
    # Create trainer and train model
    train_model = trainer.Trainer(model, finetune_dataset, None, tconf)
    train_model.train()
